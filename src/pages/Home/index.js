...
const Home = () => (
  <>
    ...
    <Title id="introductiontohooks" style={styles.title}>
    ...
    <Title id="understandingusestatearrays" style={styles.title}>
    ...
    <Title id="leveragingreuseablehooks" style={styles.title}>
    ...
    <Paragraph>
      ...
      <Paragraph style={{ marginTop: 30 }}>
        <SyntaxHighlighter margin="0">{examples.customHook}</SyntaxHighlighter>
      </Paragraph>
    ...
    <Title id="puttingthepiecestogether" style={styles.title}>
